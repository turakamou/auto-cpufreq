...
case "$(ps h -o comm 1)" in
  dinit) 
    ...
    cp /var/opt/auto-cpufreq/share/scripts/auto-cpufreq-dinit /etc/dinit.d/auto-cpufreq
  ...
  init) 
    ...
    cp /var/opt/auto-cpufreq/share/scripts/auto-cpufreq-openrc /etc/init.d/auto-cpufreq
  ...
  runit)
    ...
    runit_ln() {
      ...
      cp /var/opt/auto-cpufreq/share/scripts/auto-cpufreq-runit "$1"/sv/auto-cpufreq/run
  ...
  systemd)
    ...
    cp /var/opt/auto-cpufreq/share/scripts/auto-cpufreq.service /etc/systemd/system/auto-cpufreq.service
  ...
  s6-svscan)
    ...
    cp -r /var/opt/auto-cpufreq/share/scripts/auto-cpufreq-s6 /etc/s6/sv/auto-cpufreq
